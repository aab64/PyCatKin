...
ads_opt_dir = base_data_dir + 'energies/withoutH2O/' + metal
ads_vib_dir = base_data_dir + 'vibrations/withoutH2O/' + metal
...
results_dir = base_out_dir + 'results/withoutH2O/' + metal
figures_dir = base_out_dir + 'images/withoutH2O/' + metal
